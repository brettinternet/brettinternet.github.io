...
description: Here are the drives that have survived my storage pool
comments: true
---
...
| Drive                                                                             | Qty | Size | Unit price | Date       | Notes                                                                      |
| --------------------------------------------------------------------------------- | --- | ---- | ---------- | ---------- | -------------------------------------------------------------------------- |
...
| Seagate (ST4000NM0025)                                                            | 2   | 4TB  | free       | 2024       | Salvaged from IT dept                                                      |

---

## Failure 12/21/2025

After some SnapRAID and SMART errors, I retired my first drive from this NAS today.
...
If you're shopping for new storage, check out [DiskPrices](https://diskprices.com/).
