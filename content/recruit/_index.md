...
- I have been hard at work solving challenges with my
  ...
  dedicated to solving real-time patch management in an interesting way and
  scaling our real-time connections to a million devices.
...
_TypeScript_, _Elixir_, _Python_, and _SQL_. I'll write _YAML_ if I have to 🙂.

I am **only** open to remote work at this time.

I'm willing to discuss additional [contract or consulting](/consult) work on the
side.
...
- What can you share about the product's tech stack (e.g., frontend and backend
  technologies, other services, and legacy code)?
- What do the engineering and product teams look like (e.g., headcount,
  experience, and roles)? What does a pull request on the team look like?
