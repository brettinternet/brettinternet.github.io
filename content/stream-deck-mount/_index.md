...
The Stream Deck is an excellent tool to invoke shortcuts. Check out
...
Add a pause to the layer to add the magnetics just before the last layer of the
enclosure. Add 12 of the 6x3mm round magnets into place before continuing the
print.

{{< video autoplay="true" loop="true" src="print.mp4" >}}

When the print is complete, use a soldering iron to heat the threaded insert and
melt into the center hole. I've included a smaller print with the hole to
practice putting in the threaded insert.
